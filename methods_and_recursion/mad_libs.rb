...
adjective_2 = ask_question('Give me a another adjective: ')
noun_1 = ask_question('Give me a noun: ')
noun_2 = ask_question('Give me a another noun: ')
plural_noun_1 = ask_question('Give me a plural noun: ')
game = ask_question('Give me a game: ')
plural_noun_2 = ask_question('Give me a another plural noun: ')
verb_ending_in_ing_1 = ask_question('Give me a verb ending in "ing": ')
verb_ending_in_ing_2 = ask_question('Give me another verb ending in "ing": ')
plural_noun_3 = ask_question('Give me a plural noun: ')
verb_ending_in_ing_3 = ask_question('Give me another verb ending in "ing": ')
...
verb_ending_in_ing_4 = ask_question('Give me another verb ending in "ing":')
adjective_3 = ask_question('Give me another adjective: ')
number = ask_question('Give me a number: ')
plural_noun_4 = ask_question('Give me a plural noun: ')
...
to spend my time #{verb_ending_in_ing_1} or #{verb_ending_in_ing_2}.
When parents go on a vacation, they spend their time
eating three #{plural_noun_3} a day, and fathers play golf, and mothers
